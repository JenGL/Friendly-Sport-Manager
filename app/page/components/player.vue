<template>
    <div v-if="player" class="content-wrapper" >
        <div class="md-layout">
        ...
        <md-table class="md-medium-show" v-model="player.Matches" md-sort="data" md-sort-order="desc" md-card md-fixed-header>
            <md-table-toolbar>
        ...
        <md-table class="md-small-show" v-model="player.Matches" md-sort="data" md-sort-order="desc" md-card md-fixed-header>
            <md-table-toolbar>
                <h1 class="md-title">Matches</h1>
            </md-table-toolbar>
